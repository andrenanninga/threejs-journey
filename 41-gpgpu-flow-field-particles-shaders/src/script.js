...
// Uniforms
gpgpu.particlesVariables.material.uniforms.uTime = new THREE.Uniform(0);
gpgpu.particlesVariables.material.uniforms.uDeltaTime = new THREE.Uniform(0);
gpgpu.particlesVariables.material.uniforms.uBase = new THREE.Uniform(
	baseParticlesTexture,
);
gpgpu.particlesVariables.material.uniforms.uFlowFieldInfluence =
	new THREE.Uniform(0.5);
gpgpu.particlesVariables.material.uniforms.uFlowFieldStrength =
	new THREE.Uniform(2);
gpgpu.particlesVariables.material.uniforms.uFlowFieldFrequency =
	new THREE.Uniform(0.5);
...
gui
	...
	.name('uSize');
gui
	.add(gpgpu.particlesVariables.material.uniforms.uFlowFieldInfluence, 'value')
	.min(0)
	.max(1)
	.step(0.001)
	.name('uFlowFieldInfluence');
gui
	.add(gpgpu.particlesVariables.material.uniforms.uFlowFieldStrength, 'value')
	.min(0)
	.max(10)
	.step(0.001)
	.name('uFlowFieldStrength');
gui
	.add(gpgpu.particlesVariables.material.uniforms.uFlowFieldFrequency, 'value')
	.min(0)
	.max(1)
	.step(0.001)
